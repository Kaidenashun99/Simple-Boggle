...
public class BoggleStats {
    ...
    public String wordTester(IAutoPlayer player, ILexicon lex, ArrayList<Integer> log, int count){
    	ArrayList<BoggleBoard> allBoards = new ArrayList<BoggleBoard>();
        BoggleBoardFactory.setRandom(new Random(123));
        log.clear();
        ...
        int index = log.indexOf(max);
        System.out.println(allBoards.get(index));
